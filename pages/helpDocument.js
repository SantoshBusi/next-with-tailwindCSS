    ...
    return (
        <>
            ...
            <div className="flex space-x-5 bg-[#F2F2F2] p-5">
                <div className="w-[342px] bg-[#FFFFFF] h-auto p-3 ">
                    <div className="font-bold text-[#192228] text-[16px] pb-3 pl-10 ff-inter ">
                        Content
                    </div>
                ...
                <div className="w-[1504px] h-auto bg-[#FFFFFF] pl-12 pt-5 ">
